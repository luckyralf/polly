  ...
  <body class="Wrapped catCursor">
    ...
    <div id="nav">
      <div class="languangeButtonContainer">
        <button class="langButtonSV catPawCursor" v-on:click="switchLanguageToSV(); playSound();"></button>
        <button class="langButtonEN catPawCursor" v-on:click="switchLanguageToEN(); playSound();"></button>
